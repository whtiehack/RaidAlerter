...
function RaidAlerter_Raid_PARTY_Combat_Alerter()
	...
	if eventtype == "SPELL_CAST_SUCCESS" then
		...
		-- 	return;
		-- end
		-- 114018,潜伏帷幕 ,31821 虔诚光环 ， 114207 战旗 15286 吸血鬼拥抱   64205 神圣牺牲
		--武僧还魂术等
		if spellId == 31821 or spellId == 114018 or spellId == 64205 or spellName == RAL_TEXT_SPELL_96 or spellId == 114207 or spellId == 114203 or spellId == 114192 then
			TempUnit1 = RaidAlerter_NameToUnit(srcName);
			TempUnit2 = RaidAlerter_NameToUnit(dstName);
		...
		if spellName == RAL_TEXT_SPELL_97 or spellId == 47788 or spellId == 633 or spellId == 114039 or spellId == 1022 or spellId == 6940 or spellId == 10278 or spellId == 1038 or spellId == 29166 or spellId == 20484 or spellId == 50720 or spellId == 49016 or spellId == 33206 or spellId == 6346 or spellId == 3411 or spellId == 80398 or spellId == 108968 or spellId == 102342 then
			if RaidAlerter_SET.Paladin_Intervention then
				TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
				if TempUnit1 then
